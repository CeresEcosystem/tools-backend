  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`device_favorite_tokens\` (\`userDeviceId\` int NOT NULL, \`currentPriceId\` bigint unsigned NOT NULL, INDEX \`IDX_e79e11c2e7b1d6adcbae13e449\` (\`userDeviceId\`), INDEX \`IDX_1d1300323582900fcc5a8b5708\` (\`currentPriceId\`), PRIMARY KEY (\`userDeviceId\`, \`currentPriceId\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
